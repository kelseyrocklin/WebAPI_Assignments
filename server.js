...
apiRouter.get('/', function(req, res){
    res.json({message: 'Welcome to the api. Valid routes are /movies, /:movie_id, or /review/:movie/_id'});
});
    ...
    .get(function (req, res) {
        Movie.findById(req.params.movie_id, function(err, movie){
            ...
            if (req.query.reviews === "true") {
                ...
                Review.find({movie: req.params.movie_id}, function(err, review){
                    if(err) res.send(err);

                    res.send({movie: movie, review: review});
             });}
...
apiRouter.route('/movies/review/:movie_id')

// create a review for the movie with the passed id
    .post(function(req, res) {
        ...
        Movie.findById(req.params.movie_id, function (err, movie) {
            ...
            review.save(function (err) {
                if (err) res.json(err);
                else res.json({message: 'Review posted'});
            })
        })
    })
    // end .post function

    // displays all of the reviews for the given movie id
    .get(function(req, res){
